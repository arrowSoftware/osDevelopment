...
static void keyboardCallback(registers_t argRegs)
{
    ...
    intToAscii(scancode, scanCode_ascii);
...
void printLetter(u8 scancode)
{
    switch (scancode)
    {
        ...
        default:
            /*
             * 'keyup' event corresponds to the 'keydown' + 0x80. it may still
             * may be a scancode we haven't implemented yet, or maybe a control/
             * escape sequence.
             */
             if (scancode <= 0x7F)
             {
